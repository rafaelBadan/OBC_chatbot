...
describe InterpretService do
  ...
  end # describe #search by category end
  ...
  end # describe #list_links end

  describe '#search_links_by_hashtag' do
    it "With invalid hashtag, return don't find message" do
  ...
  end # describe #search_links_by_hashtag end
  ...
  describe '#create_link' do
    ...
    it "Without hashtag params, receive a error" do
      response = InterpretService.call('create_link', {"pathurl" => @url})
      expect(response).to match("Hashtag Obrigatória")
    end

    it "With valid params, receive success message" do
      response = InterpretService.call('create_link', {"pathurl" => @url, "hashtags" => @hashtags})
      expect(response).to match("Criado com sucesso")
    end
  ...
  end # describe #create_link end

  describe '#remove_link' do
    it "With valid ID, remove Url" do
      url = create(:url, company: @company)
      response = InterpretService.call('remove_link', {"id" => url.id})
