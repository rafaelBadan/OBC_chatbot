...
describe FaqModule::InterpretService do
  before :each do
  ...
  describe '#list' do
    it "With zero faqs, return don't find message" do
      response = FaqModule::InterpretService.call('list', {})
  ...
  describe '#search' do
    it "With empty query, return don't find message" do
      response = FaqModule::InterpretService.call('search', {"query": ''})
      expect(response).to match("Nada encontrado")
    end
    ...
    it "With valid query, find question and answer in response" do
      ...
      response = FaqModule::InterpretService.call('search', {"query" => faq.question.split(" ").sample})
  ...
  describe '#search by category' do
    it "With invalid hashtag, return don't find message" do
      response = FaqModule::InterpretService.call('search_by_hashtag', {"query": ''})
      expect(response).to match("Nada encontrado")
    end
    ...
    it "With valid hashtag, find question and answer in response" do
      ...
      response = FaqModule::InterpretService.call('search_by_hashtag', {"query" => hashtag.name})
  ...
  describe '#create' do
    ...
    it "Without hashtag params, receive a error" do
      response = FaqModule::InterpretService.call('create', {"question-original" => @question, "answer-original" => @answer})
      expect(response).to match("Hashtag Obrigatória")
    end

    it "With valid params, receive success message" do
      response = FaqModule::InterpretService.call('create', {"question-original" => @question, "answer-original" => @answer, "hashtags-original" => @hashtags})
  ...
  describe '#remove' do
    it "With valid ID, remove Faq" do
      faq = create(:faq, company: @company)
      response = FaqModule::InterpretService.call('remove', {"id" => faq.id})
      expect(response).to match("Deletado com sucesso")
    end

    it "With invalid ID, receive error message" do
      response = FaqModule::InterpretService.call('remove', {"id" => rand(1..9999)})
