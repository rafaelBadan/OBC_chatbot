...
describe FaqModule::ListService do
  ...
  describe '#call' do
    it "with list command: With zero faqs, return message: couldn't find any entries" do
    ...
    it "with search command: With empty query, return message: couldn't find" do
    ...
    it "with search_by_hashtag command: With invalid hashtag, rreturn message: couldn't find" do
